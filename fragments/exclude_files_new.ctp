...
<body class='js-excluded_files-new'>
...
<div class='container clearfix'>
    ...
    <div class='content--constrained'>
        <form accept-charset="UTF-8" action="https://treetree.beta.deployhq.com/projects/deepphpoop/excluded_files" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wfMiVhNXMb+ooNQ01R8PX1mNVqnbYdm1WCt9k1EsHX8=" /></div>
            <div class='box section section--first'>
                <div class='page-header'>
                    <h2 class='page-header__title g-heading-alpha'>New Excluded File</h2>
                    <p class='page-header__lead'>
                        Use the form below to exclude a file from your deployments.
                    </p>
                </div>
            ...
            <div class='form-submit'>
                <button class="button button--positive" name="button" type="submit">Exclude File</button>
            </div>
        </form>
