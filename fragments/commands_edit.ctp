...
<div class='container clearfix'>
    ...
    <div class='content content--constrained'>
        <div class='box section section--first section'>
            <div class='page-header'>
                <h2 class='page-header__title g-heading-alpha'>Edit SSH Command</h2>
                <p class='page-header__lead'>Use the form below to update the SSH command. The command you enter will be automatically executed <strong>before changes are pushed</strong>. All commands (and associated output) is available in your deployment log.</p>
            </div>
        </div>
        <form accept-charset="UTF-8" action="/projects/deepphpoop/commands/ff27df73-674c-ff5b-6a2a-d0506ab46d02" class="edit_command" id="edit_command_37570" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="_method" type="hidden" value="patch" /><input name="authenticity_token" type="hidden" value="wfMiVhNXMb+ooNQ01R8PX1mNVqnbYdm1WCt9k1EsHX8=" /></div><input id="command_cback" name="command[cback]" type="hidden" value="before_changes" />

            <div class='box section section--skinny section--first'>
                <div class='form-group'>
                    <label class="form-label" for="command_description">Description</label>
                    <input class="form-control" id="command_description" name="command[description]" type="text" value="PWD" />
